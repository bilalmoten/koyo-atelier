 ...
 * Features dynamic font autoscaling, instant reactive re-rendering, and 5 luxury styles.
 */
...
class LabelCanvasEngine {
  ...
  loadLogo() {
    ...
    this.logoImg.onerror = () => {
      // Try secondary logo if path failed
  ...
  /**
   * Helper to draw Koyo logo centered
   */
  ...
  async printToPrinter(endpoint = "/api/print", intensity = 135) {
    ...
    try {
      ...
      console.warn("Print error or printer offline:", err);
      throw err;
    }
  }
}
